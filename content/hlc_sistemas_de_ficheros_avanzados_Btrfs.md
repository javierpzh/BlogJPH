...
root@btrfs:~# du -h /mnt/ficheroprueba
200M	/mnt/ficheroprueba
</pre>

Vemos que el fichero ocupa un espacio de **200 MB**. Bien, ahora vamos a realizar una copia de éste. Le indicamos el parámetro `--reflink=always` para que nos permita realizar un clon de un fichero, es decir, una copia aparente basada en *CoW*.

<pre>
cp --reflink=always /mnt/ficheroprueba /mnt/ficheropruebaCoW
</pre>
