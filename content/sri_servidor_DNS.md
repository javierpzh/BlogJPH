...
En la máquina virtual, que es la que va a actuar como **servidor:**

Lo primero que debemos hacer es instalar el siguiente paquete:
...
En el cliente vamos a instalar el paquete `dnsutils`, para poder hacer uso de la herramienta `dig`:
...
nameserver 212.166.132.110
nameserver 212.166.132.104
</pre>
